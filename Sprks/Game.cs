...
public abstract class Game : Microsoft.Xna.Framework.Game {
    ...
    /// <summary>
    /// Simple readonly struct that contains all parameters to set up a new Sprks game, should be created in <c>Game.Setup</c>
    /// </summary>
    ...
    protected override sealed void Initialize() {
        Debug.WriteLine("Setting up Sprks game...");
